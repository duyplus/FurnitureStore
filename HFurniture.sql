...
INSERT customers (id, username, password, fullname, phone, email, birthday, street, city, image, token) VALUES (1, N'duyplus', N'123', N'Colin Anthony', N'0580301436', N'duyplus0909@gmail.com', CAST(N'1999-08-22' AS Date), N'3188 Feugiat. Road', N'Bình Phu?c', N'avt.png', NULL)
INSERT customers (id, username, password, fullname, phone, email, birthday, street, city, image, token) VALUES (2, N'michellewallace', N'123', N'Michelle Wallace', N'0438305787', N'michellewallace@yahoo.com', CAST(N'2000-11-02' AS Date), N'9762 Dui Road', N'Ð?k Nông', N'avt.png', NULL)
INSERT customers (id, username, password, fullname, phone, email, birthday, street, city, image, token) VALUES (3, N'wyomingjacobs', N'123', N'Wyoming Jacobs', N'0727425146', N'wyomingjacobs9494@yahoo.com', CAST(N'2001-04-20' AS Date), N'721 Eget Rd.', N'Bình Duong', N'avt.png', NULL)
INSERT customers (id, username, password, fullname, phone, email, birthday, street, city, image, token) VALUES (4, N'amyvincent', N'123', N'Amy Vincent', N'0905432692', N'amyvincent@yahoo.com', CAST(N'1998-12-17' AS Date), N'705-772 Per Av.', N'Sóc Trang', N'avt.png', NULL)
INSERT customers (id, username, password, fullname, phone, email, birthday, street, city, image, token) VALUES (5, N'selmawhitaker', N'123', N'Selma Whitaker', N'0806514932', N'selmawhitaker4705@gmail.com', CAST(N'1995-02-12' AS Date), N'7828 Vestibulum Ave', N'C?n Tho', N'avt.png', NULL)
INSERT customers (id, username, password, fullname, phone, email, birthday, street, city, image, token) VALUES (6, N'mailesargent', N'123', N'Maile Sargent', N'0186181326', N'mailesargent4847@google.com', CAST(N'2002-11-23' AS Date), N'975-4947 Iaculis Street', N'H?u Giang', N'avt.png', NULL)
INSERT customers (id, username, password, fullname, phone, email, birthday, street, city, image, token) VALUES (7, N'kessiewelch', N'123', N'Kessie Welch', N'0732975361', N'kessiewelch@yahoo.com', CAST(N'2000-09-12' AS Date), N'863-951 Eleifend Rd.', N'B?c K?n', N'avt.png', NULL)
INSERT customers (id, username, password, fullname, phone, email, birthday, street, city, image, token) VALUES (8, N'roaryfleming', N'123', N'Roary Fleming', N'0278246592', N'roaryfleming4304@gmail.com', CAST(N'2003-11-12' AS Date), N'P.O. Box 523, 849 Purus, Ave', N'Ninh Thu?n', N'avt.png', NULL)
INSERT customers (id, username, password, fullname, phone, email, birthday, street, city, image, token) VALUES (9, N'nevadarich', N'123', N'Nevada Rich', N'0628543441', N'nevadarich@gmail.com', CAST(N'1997-05-08' AS Date), N'8871 Aliquam Avenue', N'Phú Yên', N'avt.png', NULL)
INSERT customers (id, username, password, fullname, phone, email, birthday, street, city, image, token) VALUES (10, N'isabellepotts', N'123', N'Isabelle Potts', N'0228149711', N'isabellepotts@gmail.com', CAST(N'1994-06-22' AS Date), N'917-5078 Nisi. Street', N'Qu?ng Nam', N'avt.png', NULL)
