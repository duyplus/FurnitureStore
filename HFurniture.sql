...
INSERT orders (id, status, order_date, shipped_date, store_id, staff_id, customer_id) VALUES (6, 4, CAST(N'2022-11-08 01:43:00.000' AS DateTime), CAST(N'2022-11-18 22:48:00.000' AS DateTime), 4, 5, 1)
...
INSERT orders (id, status, order_date, shipped_date, store_id, staff_id, customer_id) VALUES (11, 4, CAST(N'2022-12-20 20:14:00.000' AS DateTime), CAST(N'2022-12-22 19:49:00.000' AS DateTime), 3, 2, 1)
...
INSERT orders (id, status, order_date, shipped_date, store_id, staff_id, customer_id) VALUES (14, 2, CAST(N'2022-11-14 06:01:00.000' AS DateTime), CAST(N'2022-11-10 01:07:00.000' AS DateTime), 3, 4, 1)
...
INSERT orders (id, status, order_date, shipped_date, store_id, staff_id, customer_id) VALUES (20, 2, CAST(N'2022-12-21 19:12:00.000' AS DateTime), CAST(N'2022-12-23 14:52:00.000' AS DateTime), 5, 2, 1)
...
INSERT order_details (id, quantity, list_price, discount, description, order_id, product_id) VALUES (10, 51, CAST(23749781.00 AS Decimal(10, 2)), CAST(18.00 AS Decimal(4, 2)), NULL, 12, 5)
INSERT order_details (id, quantity, list_price, discount, description, order_id, product_id) VALUES (11, 20, CAST(95341098.00 AS Decimal(10, 2)), CAST(22.00 AS Decimal(4, 2)), NULL, 3, 4)
...
INSERT order_details (id, quantity, list_price, discount, description, order_id, product_id) VALUES (13, 24, CAST(28056384.00 AS Decimal(10, 2)), CAST(19.00 AS Decimal(4, 2)), NULL, 12, 9)
INSERT order_details (id, quantity, list_price, discount, description, order_id, product_id) VALUES (14, 46, CAST(1989046.00 AS Decimal(10, 2)), CAST(25.00 AS Decimal(4, 2)), NULL, 11, 19)
...
INSERT order_details (id, quantity, list_price, discount, description, order_id, product_id) VALUES (16, 12, CAST(76516669.00 AS Decimal(10, 2)), CAST(26.00 AS Decimal(4, 2)), NULL, 20, 13)
...
INSERT order_details (id, quantity, list_price, discount, description, order_id, product_id) VALUES (19, 31, CAST(15686824.00 AS Decimal(10, 2)), CAST(26.00 AS Decimal(4, 2)), NULL, 17, 8)
